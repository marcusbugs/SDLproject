...
$(TARGET): main.o Application.o Goblin.o StaticFont.o Player.o Config.o Node.o KillStack.o
	$(CC) $(CFLAGS) -o $(TARGET) main.o Application.o Goblin.o StaticFont.o Player.o Config.o Node.o KillStack.o $(LDFLAGS)

main.o: src/main.cpp src/Application.hpp src/Vec2.hpp src/Color.hpp gorbie/StaticFont.hpp src/Config.hpp src/Player.hpp src/KillStack.hpp
	$(CC) $(CFLAGS) -c src/main.cpp

StaticFont.o: gorbie/StaticFont.cpp gorbie/StaticFont.hpp
	$(CC) $(CFLAGS) -c "gorbie/StaticFont.cpp"

Application.o: src/Application.cpp src/Application.hpp src/Color.hpp src/Goblin.hpp src/Vec2.hpp src/Config.hpp src/Player.hpp src/KillStack.hpp
...
KillStack.o: src/KillStack.cpp src/KillStack.hpp src/Node.hpp
	$(CC) $(CFLAGS) -c src/KillStack.cpp
